...
# SECURITY WARNING: keep the secret key used in production secret!, Using a environ with fallback
SECRET_KEY = os.getenv('SECRET_KEY', '22_&mdxmy2ypsjldvpa*-!*&@1o^^4@isgigc2cln-z#2jy3!v_yes_thats_a_secret_key')



ALLOWED_HOSTS = ['*'] # Change this to your site.
